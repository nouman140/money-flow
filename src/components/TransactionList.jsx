  ...
  return (
    <div className="overflow-x-auto ">
      <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
        <thead className="bg-gray-50 dark:bg-gray-800 text-black dark:text-gray-400 font-bold">
          <tr>
        ...
        <tbody className="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-800 text-left">
          {transactions.map((txn) => (
            ...
            >
              ...
              {/* Description Column */}
              <td className="px-6 py-4 whitespace-nowrap text-black dark:text-gray-400">
